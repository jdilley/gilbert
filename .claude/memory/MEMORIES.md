...
- [Source Update Service](memory-source-update-service.md) — admin-only "switch to branch X on origin" action; writes sentinel + request_restart, gilbert.sh checks out before relaunch
