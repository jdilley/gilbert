...
## Related
- [Feeds Service](memory-feeds-service.md) — owns `build_briefing` + prompts
- [Greeting Service](memory-greeting-service.md) — calls `build_briefing` from presence path
- [Capability Protocols](memory-capability-protocols.md) — `FeedsProvider`
